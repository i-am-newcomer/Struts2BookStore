...
<table width="90%" height="600px" rules="none" border="0" align="center">
	...
	<%-- 			<tr><td colspan="3" align="center"><h3>${requestScope.login_result}</h3></td></tr> --%>
				...
				<tr>
					...
					<td align="left" width="70%" colspan="2"><input type="text" name="logName" placeholder="邮箱/手机号/用户名" style="width:250px;height:25px;margin:5px;"/></td>
				</tr>
				<tr>
					<td align="right" width="30%"><span>密码</span></td>
					<td align="left" width="70%" colspan="2"><input type="password" name="logPwd" placeholder="密码" style="width:250px;height:25px;margin:5px;"/></td>
				</tr>
				<tr>
