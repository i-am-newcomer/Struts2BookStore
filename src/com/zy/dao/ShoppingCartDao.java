		...
		try {
			while(rs.next()) {
				...
				if(rs2.next()) {
					...
					Book book = new Book(rs2.getInt(1), rs2.getString(2), rs2.getFloat(3), rs2.getInt(4), rs2.getString(5), rs2.getString(6), rs2.getString(7), rs2.getString(8), rs2.getString(9));
